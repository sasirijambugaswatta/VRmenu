	...
	public class TQGGameController:MonoBehaviour 
	{
		...
		IEnumerator GameOver(float delay)
		{
			...
			if ( gameOverCanvas )    
			{
				...
				if ( gameOverCanvas.Find("ScoreTexts/TextScore") )    gameOverCanvas.Find("ScoreTexts/TextScore").GetComponent<Text>().text = "BALLINGIZ " + players[currentPlayer].score.ToString();
				...
				gameOverCanvas.Find("ScoreTexts/TextHighScore").GetComponent<Text>().text = "ENG YUQORI " + highScore.ToString();
		...
		IEnumerator Victory(float delay)
		{
			...
			if ( victoryCanvas )    
			{
				...
				{
					//Write the score text, if it exists
					victoryCanvas.Find("ScoreTexts/TextScore").GetComponent<Text>().text = "BALLINGIZ " + players[currentPlayer].score.ToString();
					//victoryCanvas.Find("ScoreTexts/TextScore").GetComponent<Text>().text =players[currentPlayer].score.ToString()+"/5";				
					//Check if we got a high score
					if ( players[currentPlayer].score > highScore )
					{
						highScore = players[currentPlayer].score;
					...
					//Write the high sscore text
					victoryCanvas.Find("ScoreTexts/TextHighScore").GetComponent<Text>().text = "ENG YUQORI " + highScore.ToString();
				}
